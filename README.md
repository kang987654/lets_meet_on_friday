...
ⓒ 2026 jinwoo — [**CC BY-NC 4.0**](LICENSE.md)

- **비상업적 사용**: 자유롭게 사용·수정·재배포할 수 있습니다. 단, **출처(이 저장소와 저작자)를
  명시**해야 합니다.
- **상업적 이용**: 허용되지 않습니다 — 원하시면 저작권자와 **별도 라이선스 협의**가 필요합니다.
- Gemma 모델은 저장소에 포함되지 않으며, 사용 시 Google 의 Gemma Terms of Use 를 따릅니다.
